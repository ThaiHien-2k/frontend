...
// },[]);
  ...
  return (
    ...
    {isLoading ? (
     ...
     <Text style={styles.text2}><Text style={styles.text3}>Ngày hiến cuối cùng: </Text> {moment(data.filter(index=> index.email.includes(auth.email)).map(i=>i.lastDonate).toString()).format("D/M/YYYY")}</Text>
